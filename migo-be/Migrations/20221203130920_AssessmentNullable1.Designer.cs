...
namespace Alliance_API.Migrations
{
    ...
    [Migration("20221203130920_AssessmentNullable1")]
    partial class AssessmentNullable1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("migo_be.AssessmentTypes.Agility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("migo_be.AssessmentTypes.Efficiency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("migo_be.AssessmentTypes.FunctionalComponents", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("migo_be.AssessmentTypes.Innovation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("migo_be.AssessmentTypes.Integrity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("migo_be.AssessmentTypes.Performance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("migo_be.AssessmentTypes.Quality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("migo_be.Models.Assessment", b =>
                {
                    b.HasOne("migo_be.AssessmentTypes.Agility", "Agility")
                        .WithMany()
                        .HasForeignKey("AgilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("migo_be.AssessmentTypes.Efficiency", "Efficiency")
                        .WithMany()
                    ...
                    b.HasOne("migo_be.AssessmentTypes.FunctionalComponents", "FunctionalComponents")
                        .WithMany()
                        .HasForeignKey("FunctionalComponentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("migo_be.AssessmentTypes.Innovation", "Innovation")
                        .WithMany()
                        .HasForeignKey("InnovationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("migo_be.AssessmentTypes.Integrity", "Integrity")
                        .WithMany()
                        .HasForeignKey("IntegrityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("migo_be.AssessmentTypes.Performance", "Performance")
                        .WithMany()
                        .HasForeignKey("PerformanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("migo_be.AssessmentTypes.Quality", "Quality")
                        .WithMany()
